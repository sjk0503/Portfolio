...
+ GPT API와 외부 API 결합 모델 개발 경험
+ Spring Boot와 MySQL 기반으로 간단한 Backend API 서버 개발
+ 서버리스(AWS) 서비스 배포 작업
+ AWS의 Lambda 함수 개발, API Gateway를 통해 API 배포
+ AWS의 RDS(MySQL) 구축, Lambda 함수와의 연동을 통해 회원 관리 및 대화 내용 백업
### Front-End Engineering
+ SwiftUI iOS 어플리케이션 개발 경험
## Experiences
### 팀 프로젝트(팀장) / [ChatAPP (24.03 ~ 24.12)](https://github.com/sjk0503/chatAPP)
#### GPT API를 활용한 영화 정보 제공 Chat app 개발 프로젝트
+ GPT API와 외부 API(Google Search API, TMDB API)를 결합한 API 개발
+ AWS 아키텍처 구성
  ![image](https://github.com/sjk0503/chatAPP/assets/108213769/9002e39e-81de-4a3e-92f6-5097f07393f1)
+ AWS의 RDS(MySQL)를 구축하여 사용자의 정보 관리
  <img width="813" alt="스크린샷 2024-06-08 오후 9 51 19" src="https://github.com/sjk0503/Portfolio/assets/108213769/d4489068-6386-4a7d-8373-ffa9ce790495">
+ 다양한 API와 결합한 Lambda 함수를 API Gateway를 통해 배포
